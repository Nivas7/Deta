...
export const dummyApplications: JobApplication[] = [
    ...
    },
    {
        ...
        notes: 'Too junior.',
        statusHistory: [
            { status: 'Applied', timestamp: getPastTimestamp(45) },
            { status: 'Rejected', timestamp: getPastTimestamp(40) },
        ],
        createdAt: getPastTimestamp(45),
        updatedAt: getPastTimestamp(40),
    },
    {
        id: 'app-rej-4',
        ...
        statusHistory: [
            ...
            { status: 'Rejected', timestamp: getPastTimestamp(10) },
        ],
